...
export const TRACKS: Record<string, Track> = {
  ...
  'green-noise': { id: 'green-noise', title: 'Green Noise', subtitle: 'Mid-band hush · nature-like', cover: 'greenNoise', duration: 'loops', category: 'noise', audio: 'green', locked: true,
  ...
  'rain-fire': { id: 'rain-fire', title: 'Rain by the Fire', subtitle: 'Steady rain · a low crackle', cover: 'rainFire', duration: 'loops', category: 'soundscape', audio: 'rainFire', locked: true,
    about: 'Our blend of the real rain and campfire recordings: shelter and warmth in one scene.' },
  'rain-ocean': { id: 'rain-ocean', title: 'Rain over the Sea', subtitle: 'Rainfall · slow swell beneath', cover: 'rainOcean', duration: 'loops', category: 'soundscape', audio: 'rainOcean', locked: true,
  ...
  'rain-forest': { id: 'rain-forest', title: 'Rain in the Forest', subtitle: 'Rainfall through the leaves', cover: 'rainForest', duration: 'loops', category: 'soundscape', audio: 'rainForest', locked: true,
  ...
  'beach-fire': { id: 'beach-fire', title: 'Beach Bonfire', subtitle: 'Waves · a close crackle', cover: 'beachFire', duration: 'loops', category: 'soundscape', audio: 'beachFire', locked: true,
    about: 'Our blend of the shoreline and campfire recordings: a small fire close by, the sea a little further out.' },
  'rain-piano': { id: 'rain-piano', title: 'Piano in the Rain', subtitle: 'Soft keys · steady rain', cover: 'rainPiano', duration: 'loops', category: 'music', audio: 'rainPiano', locked: true,
    about: 'Soft solo piano over the real rain recording. Music forward, weather behind; a gentle way to end the evening.' },
  fan: { id: 'fan', title: 'Soft Fan', subtitle: 'A steady box-fan hum', cover: 'softFan', duration: 'loops', category: 'noise', audio: 'fan', locked: true,
  ...
  'ceiling-fan': { id: 'ceiling-fan', title: 'Ceiling Fan', subtitle: 'A slow, deeper turn', cover: 'ceilingFan', duration: 'loops', category: 'noise', audio: 'ceilingFan', locked: true,
    about: 'A slower, deeper fan than Soft Fan, shaped in-house. The lazy turn of blades overhead on a warm night.' },
  'desk-fan': { id: 'desk-fan', title: 'Desk Fan', subtitle: 'Small, quick, and bright', cover: 'deskFan', duration: 'loops', category: 'noise', audio: 'deskFan', locked: true,
    about: 'A small fast fan close by, shaped in-house. Brighter and busier than the big fans; good for masking chatter.' },
  'airplane-cabin': { id: 'airplane-cabin', title: 'Airplane Cabin', subtitle: 'Cruise-altitude hush', cover: 'airplaneCabin', duration: 'loops', category: 'noise', audio: 'airplaneCabin', locked: true,
    about: 'The deep, even rush of a cabin at cruising altitude, built in-house. Many people sleep better on planes; this is why.' },
  'night-train': { id: 'night-train', title: 'Night Train', subtitle: 'A low rolling hum', cover: 'nightTrain', duration: 'loops', category: 'noise', audio: 'nightTrain', locked: true,
    about: 'The low sway of a sleeper carriage, built in-house. Steady motion without going anywhere.' },
  'ac-hum': { id: 'ac-hum', title: 'Air Conditioner', subtitle: 'A soft electrical hum', cover: 'acHum', duration: 'loops', category: 'noise', audio: 'acHum', locked: true,
    about: 'The familiar hum of a window unit, built in-house. A steady mechanical companion for hot nights.' },
  'night-drive': { id: 'night-drive', title: 'Night Drive', subtitle: 'The road from the back seat', cover: 'nightDrive', duration: 'loops', category: 'noise', audio: 'nightDrive', locked: true,
    about: 'The deep, swaying rumble of a car at night, built in-house. The sound every child falls asleep to.' },
  'tumble-dryer': { id: 'tumble-dryer', title: 'Tumble Dryer', subtitle: 'A warm, round rhythm', cover: 'tumbleDryer', duration: 'loops', category: 'noise', audio: 'tumbleDryer', locked: true,
  ...
  'soft-wind': { id: 'soft-wind', title: 'Soft Wind', subtitle: 'Gentle gusts, far off', cover: 'softWind', duration: 'loops', category: 'soundscape', audio: 'softWind', locked: true,
    about: 'A gentle wind built in-house, rising and settling in slow gusts. Air moving, nothing else.' },
  'mountain-wind': { id: 'mountain-wind', title: 'Mountain Wind', subtitle: 'Deep air over high ground', cover: 'mountainWind', duration: 'loops', category: 'soundscape', audio: 'mountainWind', locked: true,
    about: 'A deeper, heavier wind built in-house. The sound of high, open country with weather on the way.' },
  'winter-wind': { id: 'winter-wind', title: 'Winter Wind', subtitle: 'Cold and clean', cover: 'winterWind', duration: 'loops', category: 'soundscape', audio: 'winterWind', locked: true,
    about: 'A colder, brighter wind built in-house. Best enjoyed from under a heavy blanket.' },
  'leaf-wind': { id: 'leaf-wind', title: 'Wind in the Leaves', subtitle: 'A canopy moving gently', cover: 'leafWind', duration: 'loops', category: 'soundscape', audio: 'leafWind', locked: true,
  ...
  shush: { id: 'shush', title: 'Gentle Shush', subtitle: 'A slow, patient shhh', cover: 'shush', duration: 'loops', category: 'noise', audio: 'shush', locked: true,
  ...
  'rain-window': { id: 'rain-window', title: 'Rain on the Window', subtitle: 'Inside, looking out', cover: 'rainWindow', duration: 'loops', category: 'soundscape', audio: 'rainWindow', locked: true,
  ...
  'rain-tent': { id: 'rain-tent', title: 'Rain on a Tent', subtitle: 'Canvas overhead', cover: 'rainTent', duration: 'loops', category: 'soundscape', audio: 'rainTent', locked: true,
    about: 'Our rain recording shaped the way canvas carries it: close, round, and patting just above your head.' },
  'rain-distant': { id: 'rain-distant', title: 'Rain, Far Away', subtitle: 'A storm on the horizon', cover: 'rainDistant', duration: 'loops', category: 'soundscape', audio: 'rainDistant', locked: true,
    about: 'Our rain recording pushed to the horizon: quiet, low, and wide. Weather you can hear but never feel.' },
  'rain-heavy': { id: 'rain-heavy', title: 'Heavy Rain', subtitle: 'A proper downpour', cover: 'rainHeavy', duration: 'loops', category: 'soundscape', audio: 'rainHeavy', locked: true,
    about: 'Our rain deepened with a low bed underneath: a straight-down downpour with real weight to it.' },
  'deep-swell': { id: 'deep-swell', title: 'Deep Swell', subtitle: 'Slower, heavier water', cover: 'deepSwell', duration: 'loops', category: 'soundscape', audio: 'deepSwell', locked: true,
    about: 'Our shoreline recording slowed and deepened: bigger water moving further out. For heavy-blanket nights.' },
  'sea-dunes': { id: 'sea-dunes', title: 'Sea from the Dunes', subtitle: 'Waves behind the grass', cover: 'seaDunes', duration: 'loops', category: 'soundscape', audio: 'seaDunes', locked: true,
    about: 'Our ocean recording heard from behind the dunes: softened, distant, and steady.' },
  'forest-dusk': { id: 'forest-dusk', title: 'Forest at Dusk', subtitle: 'The woods settling down', cover: 'forestDusk', duration: 'loops', category: 'soundscape', audio: 'forestDusk', locked: true,
    about: 'Our forest recording shaped for the end of the day: the bright edges soften and the stream carries it.' },
  'birds-far': { id: 'birds-far', title: 'Birds, Far Off', subtitle: 'A distant morning', cover: 'birdsFar', duration: 'loops', category: 'soundscape', audio: 'birdsFar', locked: true,
    about: 'Our dawn chorus set back across a field: present, but no single bird close enough to wake you.' },
  embers: { id: 'embers', title: 'Dying Embers', subtitle: 'The fire, late', cover: 'embers', duration: 'loops', category: 'soundscape', audio: 'embers', locked: true,
  ...
  'piano-fire': { id: 'piano-fire', title: 'Piano by the Fire', subtitle: 'Soft keys · a close crackle', cover: 'pianoFire', duration: 'loops', category: 'music', audio: 'pianoFire', locked: true,
    about: 'Our blend of the soft piano and the campfire. Music in a warm room.' },
  'piano-sea': { id: 'piano-sea', title: 'Piano by the Sea', subtitle: 'Soft keys · a slow swell', cover: 'pianoSea', duration: 'loops', category: 'music', audio: 'pianoSea', locked: true,
    about: 'Our blend of the soft piano over the ocean swell. Unhurried on both counts.' },
  'piano-birds': { id: 'piano-birds', title: 'Morning Keys', subtitle: 'Soft keys · early birdsong', cover: 'pianoBirds', duration: 'loops', category: 'music', audio: 'pianoBirds', locked: true,
    about: 'Our blend of the soft piano with the dawn chorus behind it. A gentler way to come back to the day.' },
  'gymnopedie-rain': { id: 'gymnopedie-rain', title: 'Gymnopédie in the Rain', subtitle: 'Satie · steady rain', cover: 'gymnopedieRain', duration: 'loops', category: 'music', audio: 'gymnopedieRain', locked: true,
    about: 'Satie’s slow piano piece over our rain recording. Two calm things that belong together.' },
  'forest-campfire': { id: 'forest-campfire', title: 'Forest Campfire', subtitle: 'A fire under the trees', cover: 'forestCampfire', duration: 'loops', category: 'soundscape', audio: 'forestCampfire', locked: true,
    about: 'Our blend of the forest and the campfire: birdsong and stream around you, the fire in front.' },
  'shore-morning': { id: 'shore-morning', title: 'Morning Shoreline', subtitle: 'Waves · first birdsong', cover: 'shoreMorning', duration: 'loops', category: 'soundscape', audio: 'shoreMorning', locked: true,
    about: 'Our blend of the waves with early birdsong. The beach before anyone else is on it.' },
  'fireside-hush': { id: 'fireside-hush', title: 'Fireside Hush', subtitle: 'The fire · a deep quiet', cover: 'firesideHush', duration: 'loops', category: 'soundscape', audio: 'firesideHush', locked: true,
    about: 'Our campfire seated on a deep, even hush. The crackle stays; the silence between it gets softer.' },
  'storm-rolling': { id: 'storm-rolling', title: 'Storm Rolling In', subtitle: 'Rain · waves · low weight', cover: 'stormRolling', duration: 'loops', category: 'soundscape', audio: 'stormRolling', locked: true,
    about: 'Our blend of rain over breaking waves with a low bed beneath: the hour when the weather arrives.' },
  'the-cabin': { id: 'the-cabin', title: 'The Cabin', subtitle: 'Rain on the roof · a fire · the sea', cover: 'theCabin', duration: 'loops', category: 'soundscape', audio: 'theCabin', locked: true,
