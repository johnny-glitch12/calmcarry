...
export const TRACK_TAGS: Record<string, Tags> = {
  ...
  'cyclic-sigh': { moods: ['racing', 'wound-up', 'cant-switch-off'], intents: ['reset'], parts: ALL, kidSafe: true },
  'extended-exhale': { moods: ['wound-up', 'wired-tired', 'racing'], intents: ['reset', 'sleep'], parts: ALL, kidSafe: true },
  'four-seven-eight': { moods: ['racing', 'cant-switch-off', 'wired-tired'], intents: ['reset', 'sleep'], parts: EN, kidSafe: true },
